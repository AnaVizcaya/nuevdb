...
#include <nuevdb/IFDatabase/RunConditionsProtoDUNE.h>

// nutools includes
#include <nuevdb/IFDatabase/Table.h>
//#include "/dune/app/users/avizcaya/toolsServices/install/source/nuevdb/IFDatabase/Table.h"
...
//------------------------------------------------
bool runc::RunConditionsProtoDUNE::UpdateRun(uint64_t ts) 
{
...
bool runc::RunConditionsProtoDUNE::LoadRunConditions()
{
  ...
  //nutools::dbi::fUConDBURL = "https://dbdata0vm.fnal.gov:9443/dune_runcon_prod/"
  ...
  std::cout << "This is the run number I'll be using" << fCurrentTS << std::endl;
